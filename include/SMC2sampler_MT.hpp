#ifndef SMC2_SAMPLER_MT
#define SMC2_SAMPLER_MT
#include <Eigen/Core>
#include <Eigen/Dense>
#include <cuda.h>
#include <curand.h>
...
__global__
void MetropolisResampling(curandStateMtgp32 *global_state, double *weights, const int N_theta, const int iters, int* ancestors);
__global__
void PropagateState(curandStateMtgp32 *global_state, const int T_current, double *x_t, double *w_x_t, double *L, const cuData &data);
__global__
...
__global__
void SMC2_init( curandStateMtgp32 *state, 
                const cuData &data, 
                double *theta, 
                double *w_theta, 
                double *f, 
...
// __global__
// void ResampleThetaParticles(curandStateMtgp32 *global_state, 
//                             const int T_current,
